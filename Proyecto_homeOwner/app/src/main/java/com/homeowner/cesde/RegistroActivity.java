...
public class RegistroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jetClave2=findViewById(R.id.etClaveNueva3);
                            ...
                            db.collection("users").document(email)
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Toast.makeText(getApplicationContext(), "Registro guardado satisfactoriamente", Toast.LENGTH_LONG).show();
                                            ...
                                            // Log.d("coronado", "DocumentSnapshot successfully written!");
                                        }
                                    })
                                    .addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Log.w("coronado2", "Error writing document", e);
                                        }
                                    });
                            */
                        }
